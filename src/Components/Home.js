...
function Home() {
  ...
  return (
    <div style={{
        ...
        <Link to ="/bmi"><button className="button">BMI</button></Link>
        <Link to ="/blogs"><button className="button">Blogs</button></Link>
        <Link to ="/about"><button className="button">About</button></Link> 
    </div>
        <div className="heading" >
       
            <div className="Text1">Transform to your best shape with Fitness-Pro</div>
